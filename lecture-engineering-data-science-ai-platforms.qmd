...
- (...)
- **Chapter 11: Batch Processing**<br>Batch Processing in Distributed Systems - Batch Processing Models - Batch Use Cases_
:::

::: {.column width="40%"}

![](images/ddia-2.jpg){fig-align="right"}
...
{{< source "Reis & Housley (2022)" url="https://www.oreilly.com/library/view/fundamentals-of-data/9781098108298/">}}

![](images/reiss-data-engineering.png)

#  MLOps {background-image="images/xkcd-2582-data-trap.png" background-size="30%"}
